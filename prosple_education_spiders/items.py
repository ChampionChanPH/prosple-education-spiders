...
class Employer(scrapy.Item):
    ...
    alt_employer_name = scrapy.Field()
    opportunity_type = scrapy.Field()
    overview = scrapy.Field()
    summary = scrapy.Field()
    industry_sector = scrapy.Field()
    location_description = scrapy.Field()
    contact_name = scrapy.Field()
    contact_phone = scrapy.Field()
    contact_email = scrapy.Field()
    no_of_employees = scrapy.Field()
    location = scrapy.Field()
    hiring_from = scrapy.Field()
    url_facebook = scrapy.Field()
    url_twitter = scrapy.Field()
    url_linkedin = scrapy.Field()
    url_youtube = scrapy.Field()
    url_instagram = scrapy.Field()
    exclude_subscription = scrapy.Field()
    logo = scrapy.Field()
    recruitment_overview = scrapy.Field()
    career_overview = scrapy.Field()
    target_region = scrapy.Field()
