...
course_data = pkgutil.get_data("prosple_education_spiders", "resources/csf_courses.csv").decode("utf-8")
...
#     name = 'csf_spider'
#     start_urls = ['https://csf.edu.au/courses/']
#     institution = "College of Sports and Fitness"
#     uidPrefix = "AU-CSF-"
#
#     campuses = {
#         "Sydney CBD": "82358",
...
#
#             if re.search('computer networking', name, flags=re.I) and \
#                     re.search('certificate', name, flags=re.I):
#                 course_item['degreeType'] = 'Certificate'
#
#             if name:
